...
##
#   options required for gnu coverage
##
ifneq ($(EN_COVERAGE), )
	EXTRA_CSRCDIR += $(EMBARC_ROOT)/tests/gcov
	EXTRA_INCDIR += $(EMBARC_ROOT)/tests/gcov
	EXTRA_DEFINES += -DCOVERAGE_ENABLED
	COMPILE_OPT     += -fprofile-arcs -ftest-coverage
	LINK_OPT        += -fprofile-arcs -ftest-coverage
	OPT_OLEVEL = -O0
endif

ifneq (,$(filter EMBARC_UNIT_TEST,$(APPL_DEFINES)))
